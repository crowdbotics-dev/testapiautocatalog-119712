...
## Project Structure
    ...
    ├── testapiautocatalog_119712  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_119712`
...
2. Clone this repo and `cd testapiautocatalog_119712`
